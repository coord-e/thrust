...
- `THRUST_OUTPUT_DIR`: When configured, Thrust outputs intermediate smtlib2 files into this directory, along with the MIR of each analyzed function as `<function path>.mir`.
