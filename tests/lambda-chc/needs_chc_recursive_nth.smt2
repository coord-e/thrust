...
; c7
(assert (forall ((v0 Int) (v1 A0_Tuple<Array<Int-Int>-Int>) (v2 Int) (v3 A0_Tuple<Array<Int-Int>-Int>) (v4 Int) (v5 Int)) (=> (and (p4 v2 v0 v1) (= v3 v1) (= v4 v2) (= v5 v0) true) (p1 v5 v3 v4))))
